...
OBSERVED_TASKS = {
    ...
    'app.apps.receivables.tasks.notify_boleto_paid',
    'app.apps.receivables.tasks.process_boleto_daily_notifications',
    'app.apps.receivables.tasks.send_boleto_email',
    'app.apps.receivables.tasks.send_boleto_manager_digest',
