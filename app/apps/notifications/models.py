...
EVENT_VARIABLES = {
    ...
    'link_created': ['vendedor', 'cliente', 'valor', 'parcelas', 'link'],
    'payment_paid': ['vendedor', 'cliente', 'valor', 'parcelas', 'link'],
    'link_canceled': ['vendedor', 'cliente', 'valor', 'parcelas', 'link'],
    'payment_expired': ['vendedor', 'cliente', 'valor', 'parcelas', 'link'],
    'payment_failed': ['vendedor', 'cliente', 'valor', 'link', 'motivo'],
    'payment_refunded': ['vendedor', 'cliente', 'valor', 'parcelas', 'link'],
