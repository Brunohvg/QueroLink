...
self.addEventListener('fetch', function(event) {
    ...
    if (isAuthPath(url)) {
        event.respondWith(fetch(event.request).catch(function() {
            return new Response(
                '<!DOCTYPE html><html lang="pt"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>V-Com</title><style>body{font-family:-apple-system,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:#f8fafc;color:#2d3748;text-align:center;padding:20px}h1{color:#1263FF;font-size:1.5rem}p{color:#64748b;margin-top:.5rem}</style></head><body><div><h1>Sem conexao</h1><p>Pagina nao disponivel offline.</p></div></body></html>',
